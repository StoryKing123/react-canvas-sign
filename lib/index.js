...
const Canvas = forwardRef((props, ref) => {
  ...
  const handleMouseMove = (e) => {
    const canvasElement = getCanvasByRef();
    draw(e.clientX - canvasElement.getBoundingClientRect().left, e.clientY - canvasElement.getBoundingClientRect().top);
  };
  ...
  const handleMouseDown = (e) => {
    ...
    handleStyleInit();
    context.beginPath();
    context.moveTo(e.clientX - canvasElement.getBoundingClientRect().left, e.clientY - canvasElement.getBoundingClientRect().top);
  };
  ...
  const handleTouchStart = (e) => {
    e.preventDefault();
    const canvasElement = getCanvasByRef();
    beforeDraw(e.changedTouches[0].pageX - canvasElement.getBoundingClientRect().left, e.changedTouches[0].pageY - canvasElement.getBoundingClientRect().top);
  };
